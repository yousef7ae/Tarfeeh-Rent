    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input value="" wire:model.defer="service_category.name" placeholder="{{ __('Add Name') }}"
                       name="name"
...
{{--                        <select  wire:change = "getCities()" wire:model.defer="service_category.city_id"--}}
...
{{--            </div>--}}
            ...
            <div class="form-group" wire:ignore>
                ...
                <textarea rows="5" value="" wire:model.defer="service_category.description" placeholder="{{ __('Add Description') }}"
